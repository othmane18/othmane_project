                ...
                <div class="card">  
                        ...
                        <form action="{{route('etablissement.store')}}" method="POST"> 
                            {{ csrf_field() }}
                                        ...
                                        <input type="text" class="form-control" name="libelle_etablissement">
                                        </div>
                                        ...
                                        <input type="text" class="form-control" name="code_grisa">
                                        </div>
    
                                        <div class="form-group">
                                        <label for="ville_etablissement">Ville Etablissement : </label>
                                        <input type="text" class="form-control" name="ville_etablissement">
                                        </div>
                                        ...
                                        <input type="text" class="form-control" name="telephone_etablissement">
                                        </div> 
