        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action='{{ url("/ajouter/directeur_prov") }}'>
                        @csrf

                        <div class="form-group row">
                            <label for="nom_directeurprovinciale" class="col-md-4 col-form-label text-md-right">{{ __('Nom :') }}</label>
                            <div class="col-md-6">
                                <input id="nom_directeurprovinciale" type="text" class="form-control @error('nom_directeurprovinciale') is-invalid @enderror" name="nom_directeurprovinciale" value="{{ old('nom_directeurprovinciale') }}" autocomplete="nom_directeurprovinciale" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="prenom_directeurprovinciale" type="text" class="form-control @error('prenom_directeurprovinciale') is-invalid @enderror" name="prenom_directeurprovinciale" value="{{ old('prenom_directeurprovinciale') }}" autocomplete="prenom_directeurprovinciale" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="adresse_directeurprovinciale" type="text" class="form-control @error('adresse_directeurprovinciale') is-invalid @enderror" name="adresse_directeurprovinciale" value="{{ old('adresse_directeurprovinciale') }}" autocomplete="adresse_directeurprovinciale" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="hidden" id="role" type="text" class="form-control @error('role') is-invalid @enderror" name="role" value="dirprv" autocomplete="role" autofocus>
